...
/**
 * Copied from package org.eclipse.jdt.internal.corext.refactoring.code
 */
public class AstMatchingNodeFinder {
	...
	private static class Visitor extends ASTVisitor{
		...
		private class Matcher extends ASTMatcher {
			...
			public boolean match(SimpleName node, Object other) {
				...
				return node.getFullyQualifiedName().equals(name.getFullyQualifiedName());	
			}
			
			public boolean match(StringLiteral node, Object other){
				boolean isomorphic= super.match(node, other);
				if (! isomorphic || !(other instanceof StringLiteral))
					return false;
				
				StringLiteral name= (StringLiteral)other;
				return node.getLiteralValue().equals(name.getLiteralValue());	
			}
		}
